...
describe 'ensure_safe_name' do
  ...
  it 'should raise an error if clone is given an unsafe name' do
    expect { Lamp::Lesson.clone_from 'x', '../jimjh/x' }.to raise_error E
  end

  it 'should raise an error if compile is given an unsafe name' do
    expect { Lamp::Lesson.compile '../jimjh/x' }.to raise_error E
  end

  it 'should raise an error if create is given an unsafe name' do
